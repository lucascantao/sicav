...
@section('content')
    ...
    $breadcrumb = [
        ...
        'breadcrumbs' => [
            ...
            ['title' => 'Editar', 'url' => route('unidade.edit', ['unidade' => $unidade->id])],
        ]
    ];
    @endphp
    ...
    <div>
        <div class="card border-0 card-body m-4 px-6 py-6">
            ...
            <form method="post" action="{{route('unidade.update', ['unidade' => $unidade])}}">
            @csrf
            @method('put')
                <div class="row mb-3">
                    <div class="col-6 mb-3">
                        <b><label for="nome" class="form-label">Nome <span style="color: red"> *</span></label></b>
                        <input type="text" class="form-control" maxlength="100" name="nome" style="text-transform: uppercase;" value="{{$unidade->nome}}">
                    </div>
                </div>
                <div>
